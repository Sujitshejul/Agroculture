				...
				<center>
					<div class="row uniform">
						<div class="6u 12u$(xsmall)">
							<button class="button fit" onclick="document.getElementById('id03').style.display='block'" style="width:auto">REGISTER-FARMER</button>
						</div>
						
						<div class="6u 12u$(xsmall)">
							<button class="button fit" onclick="document.getElementById('id02').style.display='block'" style="width:auto">REGISTER-BUYER</button>
						</div>
						<div class="6u 12u$(xsmall)">
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
				                        ...
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="buyer" name="category" value="2" checked>
				                            <label for="buyer">Buyer</label>
				                        </div> 
									</div>
								<div class="row uniform">
...
var model2 = document.getElementById('id03');
window.onclick = function(event) {
